export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	babysheep: {
		...
		baseForme: "Normal",
		types: ["Normal"],
		baseStats: { hp: 72, atk: 44, def: 64, spa: 84, spd: 64, spe: 72 },
		abilities: { 0: "Multicolor" },
		heightm: 0.5,
		weightkg: 30,
		color: "White",
		evos: ["Sheep"],
		eggGroups: ["Undiscovered"],
		otherFormes: ["Baby Sheep-Fire", "Baby Sheep-Grass", "Baby Sheep-Water"],
		formeOrder: [
			"Baby Sheep", "Baby Sheep-Fire", "Baby Sheep-Grass", "Baby Sheep-Water",
		],
	},
	babysheepfire: {
		num: -402,
		name: "Baby Sheep-Fire",
		baseSpecies: "Baby Sheep",
		forme: "Fire",
		types: ["Fire"],
		baseStats: { hp: 72, atk: 44, def: 64, spa: 84, spd: 64, spe: 72 },
		abilities: { 0: "Multicolor" },
		...
		changesFrom: "Baby Sheep",
	},
	babysheepgrass: {
		num: -402,
		name: "Baby Sheep-Grass",
		baseSpecies: "Baby Sheep",
		forme: "Grass",
		types: ["Grass"],
		baseStats: { hp: 72, atk: 44, def: 64, spa: 84, spd: 64, spe: 72 },
	...
	sheep: {
		...
		baseForme: "Normal",
		types: ["Normal"],
		baseStats: { hp: 90, atk: 55, def: 80, spa: 105, spd: 80, spe: 90 },
		abilities: { 0: "Multicolor" },
		heightm: 1,
		weightkg: 65,
		color: "White",
		...
		evoItem: "Shiny Stone",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Sheep-Fire", "Sheep-Grass", "Sheep-Water"],
		formeOrder: [
			"Sheep", "Sheep-Fire", "Sheep-Grass", "Sheep-Water",
		],
	},
	sheepfire: {
		num: -403,
	...
	cow: {
		...
		name: "Cow",
		types: ["Normal"],
		baseStats: { hp: 72, atk: 72, def: 60, spa: 48, spd: 100, spe: 48 },
		abilities: { 0: "Natural Cure", 1: "Cud Chew" },
		heightm: 1,
		weightkg: 65,
		color: "Brown",
		evos: ["Mooshroom"],
	...
	mooshroom: {
		...
		name: "Mooshroom",
		types: ["Normal", "Grass"],
		baseStats: { hp: 90, atk: 90, def: 75, spa: 60, spd: 125, spe: 60 },
		abilities: { 0: "Natural Cure", 1: "Cud Chew" },
		heightm: 1,
		weightkg: 65,
		color: "Red",
	...
	zombie: {
		...
		weightkg: 65,
		color: "Green",
		evos: ["Zombie Giant", "Husk", "Drowned"],
		eggGroups: ["Undiscovered"],
	},
	zombiegiant: {
		num: -416,
	...
	drowned: {
		...
		name: "Drowned",
		types: ["Dark", "Water"],
		baseStats: { hp: 110, atk: 85, def: 100, spa: 55, spd: 75, spe: 75 },
		abilities: { 0: "Strong Jaw", 1: "Stamina" },
		heightm: 2,
		weightkg: 65,
		color: "Blue",
	...
	skeleton: {
		...
		name: "Skeleton",
		types: ["Ground"],
		baseStats: { hp: 64, atk: 84, def: 68, spa: 48, spd: 56, spe: 80 },
		abilities: { 0: "Long Reach" },
		heightm: 2,
		weightkg: 20,
		color: "White",
		evos: ["Spider Jockey", "Stray", "Bogged"],
		eggGroups: ["Undiscovered"],
	},
	spiderjockey: {
		num: -420,
		name: "Spider Jockey",
		types: ["Ground", "Bug"],
		baseStats: { hp: 80, atk: 105, def: 80, spa: 60, spd: 65, spe: 110 },
		abilities: { 0: "Long Reach" },
		heightm: 2,
		weightkg: 85,
		color: "White",
	...
	stray: {
		...
		name: "Stray",
		types: ["Ground", "Ice"],
		baseStats: { hp: 80, atk: 105, def: 95, spa: 60, spd: 65, spe: 95 },
		abilities: { 0: "Long Reach" },
		heightm: 2,
		weightkg: 20,
		color: "Blue",
	...
	creeper: {
		...
		name: "Creeper",
		types: ["Normal"],
		baseStats: { hp: 60, atk: 100, def: 52, spa: 60, spd: 60, spe: 68 },
		abilities: { 0: "Reckless" },
		heightm: 2,
		weightkg: 65,
		color: "Green",
		evos: ["Charged Creeper"],
		eggGroups: ["Undiscovered"],
	},
	chargedcreeper: {
		num: -426,
		...
		baseStats: { hp: 75, atk: 125, def: 65, spa: 75, spd: 75, spe: 85 },
		abilities: { 0: "Reckless" },
		heightm: 2,
		weightkg: 65,
		color: "Green",
	...
	wolf: {
		...
		name: "Wolf",
		types: ["Normal"],
		baseStats: { hp: 60, atk: 72, def: 92, spa: 44, spd: 52, spe: 80 },
		abilities: { 0: "Intimidate", 1: "Filter" },
		heightm: 1,
		weightkg: 65,
		color: "White",
		evos: ["Armored Wolf"],
	...
	armoredwolf: {
		...
		name: "Armored Wolf",
		types: ["Normal", "Rock"],
		baseStats: { hp: 75, atk: 90, def: 125, spa: 55, spd: 65, spe: 90 },
		abilities: { 0: "Intimidate", 1: "Solid Rock" },
		heightm: 1,
		weightkg: 65,
		color: "Brown",
		prevo: "Wolf",
	...
	goat: {
		...
		name: "Goat",
		types: ["Normal"],
		baseStats: { hp: 110, atk: 90, def: 70, spa: 90, spd: 60, spe: 80 },
		abilities: { 0: "Immunity", 1: "Punk Rock" },
		heightm: 1,
		weightkg: 65,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	silverfish: {
		...
		name: "Silverfish",
		types: ["Bug"],
		baseStats: { hp: 44, atk: 64, def: 60, spa: 64, spd: 76, spe: 92 },
		abilities: { 0: "Earth Eater", 1: "Swarm" },
		heightm: 0.5,
		weightkg: 10,
		color: "White",
		evos: ["Redstone Bug"],
	...
	redstonebug: {
		...
		name: "Redstone Bug",
		types: ["Bug", "Electric"],
		baseStats: { hp: 55, atk: 80, def: 75, spa: 80, spd: 95, spe: 115 },
		abilities: { 0: "Earth Eater", 1: "Swarm" },
		heightm: 0.5,
		weightkg: 10,
		color: "Red",
	...
	axolotl: {
		...
		name: "Axolotl",
		types: ["Water", "Fairy"],
		baseStats: { hp: 125, atk: 85, def: 65, spa: 60, spd: 80, spe: 85 },
		...
		name: "Squid",
		types: ["Water"],
		baseStats: { hp: 48, atk: 52, def: 60, spa: 80, spd: 92, spe: 68 },
		abilities: { 0: "Unnerve", 1: "Wonder Skin" },
		heightm: 2,
		weightkg: 35,
		color: "Blue",
		evos: ["Glow Squid"],
	...
	glowsquid: {
		...
		name: "Glow Squid",
		types: ["Water", "Fairy"],
		baseStats: { hp: 60, atk: 65, def: 75, spa: 100, spd: 115, spe: 85 },
		abilities: { 0: "Unnerve", 1: "Wonder Skin" },
		heightm: 2,
		weightkg: 35,
		color: "Blue",
	...
	elderguardian: {
		...
		name: "Elder Guardian",
		types: ["Water", "Steel"],
		baseStats: { hp: 80, atk: 60, def: 105, spa: 120, spd: 70, spe: 65 },
		abilities: { 0: "Iron Barbs", 1: "Intimidate" },
		heightm: 3,
		weightkg: 195,
		color: "White",
	...
	armadillo: {
		...
		name: "Armadillo",
		types: ["Rock"],
		baseStats: { hp: 95, atk: 80, def: 115, spa: 60, spd: 75, spe: 75 },
		abilities: { 0: "Rock Head", 1: "Emergency Exit" },
		heightm: 1,
		weightkg: 30,
		color: "Brown",
		eggGroups: ["Undiscovered"],
	...
	irongolem: {
		...
		name: "Iron Golem",
		types: ["Steel"],
		baseStats: { hp: 90, atk: 110, def: 125, spa: 55, spd: 60, spe: 60 },
		abilities: { 0: "Full Metal Body", 1: "Iron Fist" },
		heightm: 3,
		weightkg: 300,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	illusioner: {
		...
		baseStats: { hp: 80, atk: 95, def: 70, spa: 65, spd: 95, spe: 95 },
		abilities: { 0: "Frisk", 1: "Reciever" },
		heightm: 2,
		weightkg: 65,
		color: "Blue",
	...
	ravagerjockey: {
		...
		baseStats: { hp: 100, atk: 125, def: 100, spa: 65, spd: 50, spe: 60 },
		abilities: { 0: "Punk Rock", 1: "Unnerve" },
		heightm: 4,
		weightkg: 260,
		color: "Gray",
	...
	breeze: {
		...
		baseStats: { hp: 65, atk: 55, def: 85, spa: 115, spd: 65, spe: 115 },
		abilities: { 0: "Sniper", 1: "Aerilate" },
		heightm: 2,
		weightkg: 10,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	witherskeleton: {
		...
		types: ["Ghost", "Poison"],
		baseStats: { hp: 65, atk: 110, def: 90, spa: 55, spd: 75, spe: 105 },
		abilities: { 0: "Corrosion", 1: "Super Luck" },
		heightm: 2,
		weightkg: 20,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	enderman: {
		...
		name: "Enderman",
		types: ["Psychic"],
		baseStats: { hp: 110, atk: 90, def: 60, spa: 60, spd: 95, spe: 85 },
		abilities: { 0: "Rocky Payload", 1: "Super Luck" },
		heightm: 3,
		weightkg: 80,
		color: "Black",
		eggGroups: ["Undiscovered"],
